      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-8xl lg:mx-0">
          ...
          <p className="mt-6 text-lg/8 text-gray-600 text-center">
            Команда Адвокатской фирмы «Бурков, Радев и партнёры» уникальным
            образом сочетает в себе опыт, креативность, постоянство и жажду
            знаний. Фирма предлагает своим клиентам комплексные юридические
            услуги, включительно по вопросам, связанным с облигационным,
            имущественным, семейным и наследственным правом, коммерческим и
            трудовым правом, правом интеллектуальной собственности, гражданским
            и административным процессом. Наши юристы имеют большой опыт
            консультирования по некоторым новейшим и быстроразвивающимся сферам
            бизнеса, таким как: медиа (телевидение, радио и Интернет),
            телекоммуникации, маркетинг и реклама, создание контента, новые
            технологии и др. Рабочие языки: болгарский, английский, сербский,
            русский, немецкий.
          </p>
        </div>
        <ul

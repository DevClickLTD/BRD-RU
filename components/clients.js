        ...
        <div className="grid grid-cols-1 items-center gap-x-8 gap-y-16 lg:grid-cols-2">
          <div className="mx-auto w-full max-w-xl lg:mx-0">
            ...
            <p className="mt-6 text-lg/8 text-gray-600">
              ...
              коммерческих компаний в сферах услуг, строительства, энергетики, а
              также производственных компаний, банковских и небанковских
              финансовых учреждений, неправительственных организаций. В
              стремлении защитить интересы наших клиентов, мы сотрудничает с
              широким кругом специалистов, в том числе бухгалтеров, инженеров,
              страховщиков и так далее.
            </p>
          </div>

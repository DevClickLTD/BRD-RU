...
export async function generateMetadata() {
  return {
    title: "Контакты - Адвокатское бюро „Бурков, Радев и партнёры“",
    description:
      "Свяжитесь с Адвокатское бюро „Бурков, Радев и партнёры“ для юридической консультации. Наш коллектив готов ответить на ваши вопросы и предложить экспертные решения. Найдите наши контакты и адрес здесь.",
  };
}
...
export default async function ContactPage() {
  ...
  return (
    <div className="relative isolate bg-white">
      ...
      {/* Google Maps секция на пълен екран */}

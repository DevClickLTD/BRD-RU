...
export async function generateMetadata() {
  ...
  return {
    ...
    title: 'Адвокатско дружество "Бурков, Радев и партньори"',
    description:
    ...
    openGraph: {
      ...
      type: "website",
      locale: "bg_BG",
      siteName: 'Адвокатско дружество "Бурков, Радев и партньори"',
    },
    twitter: {
...
export default function RootLayout({ children }) {
  return (
    <html lang="bg">
      ...
      <NextTopLoader color="#95161c" showSpinner={false} />
        <ImagePreloader />
        <Navigation />
        <main>{children}</main>
        <CookieConsentBanner />
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "LegalService",
              name: 'Адвокатско дружество "Бурков, Радев и партньори"',
              description:
                "Вашият доверен правен партньор. Предлагаме висококачествени правни услуги в областта на търговското, гражданското, наказателното и административното право.",
              url: "https://brd.bg",
              contactPoint: {

...
export const metadata = {
  title: 'Услуги - Адвокатско дружество "Бурков, Радев и партньори"',
  description:
    'Разгледайте правните услуги, които предлага Адвокатско дружество "Бурков, Радев и партньори". Специализираме в търговско, гражданско, наказателно и административно право, като осигуряваме експертни решения и индивидуален подход към всеки клиент.',
};

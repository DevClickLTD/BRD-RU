...
export async function generateMetadata() {
  return {
    title:
      "Политика конфиденциальности - Юридическая фирма «Бурков, Радев и партнёры»“",
    description:
  ...
  return (
    <div className="container mx-auto p-6 max-w-5xl bg-white py-12">
      ...
      <p className="mb-4 text-gray-700">
        ...
        фирма «Бурков, Радев и партнёры»» («Мы», «Наша юридическая фирма»)
        собирает, использует и защищает персональные данные пользователей нашего
        веб-сайта. Бурков, Радев и партнёры» («Мы», «Наш офис») собирает,
